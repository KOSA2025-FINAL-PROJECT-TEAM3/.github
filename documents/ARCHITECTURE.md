...
자세한 내용:
- [`documents/DATABASE_SCHEMA_ANALYSIS.md`](https://github.com/KOSA2025-FINAL-PROJECT-TEAM3/.github/blob/dev/documents/DATABASE_SCHEMA_ANALYSIS.md)
...
- 레포별 분석: [`documents/REPOSITORIES.md`](https://github.com/KOSA2025-FINAL-PROJECT-TEAM3/.github/blob/dev/documents/REPOSITORIES.md)
- 라우팅/프로필: [`documents/MICROSERVICES_SETUP.md`](https://github.com/KOSA2025-FINAL-PROJECT-TEAM3/.github/blob/dev/documents/MICROSERVICES_SETUP.md)
